...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("X - Control of work orders");
        setResizable(false);
        ...
        desktop.setPreferredSize(new java.awt.Dimension(640, 500));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/samuelprojetos/icones/imgIcon.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(966, 605));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // as linhas abaixo substituiem a label lbldata pela data atual do sistema ao inicializar o form
        Date data = new Date();
    ...
    private void MenCadUsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenCadUsuActionPerformed
        // as linha abaixo vao abrir o form TelaUsuario dentro do desktop pane
    ...
    private void menRelCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menRelCliActionPerformed
        ...
        int confirma = JOptionPane.showConfirmDialog(null,"Confirma a impressao deste relaotio?","Atençao",JOptionPane.YES_NO_OPTION);
        if(confirma == JOptionPane.YES_OPTION){
            try {
                // usando a classe JasperPrint para preparar a impressao de relatorio
                JasperPrint print = JasperFillManager.fillReport("C:\\Users\\Samuel\\Documents\\NetBeansProjects\\report\\MyReports\\tbclientes.jasper", null,conexao);
                //a linha abaixo exibir o relatorio atraves da classe JasperViewer
